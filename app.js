...
const districtSnakeToCamel = (newObject) => {
  return {
    ...
    stateId: new_object.state_id,
    cases: new_object.cases,
    cured: new_object.cured,
    active: new_object.active,
...
//Returns a state based on the stateID
...
//Returns a district bases on the district ID
...
app.get("/states/:stateId/stats/", async(request, response) => {
    ...
    const resultReport  = reportSnakeToCamelCase(stateReprot);
